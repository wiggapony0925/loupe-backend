...
BANDS: list[tuple[str, str, range]] = [
    (
        "Empty / first-run",
        "Brand-new accounts, scanner-only, or one-card vaults.",
        range(1, 6),
    ),
    ("Beginners", "Single-TCG vaults with 3 – 8 cards.", range(6, 16)),
    (
        "Intermediate",
        "10 – 30 cards, deeper history, sometimes a second device.",
        range(16, 26),
    ),
    ...
    (
        "Edge cases",
        "All-gem-mint, all-low-grade, SSO, stale scanners, etc.",
        range(41, 51),
    ),
]
