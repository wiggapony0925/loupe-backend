...
management, jobs, applications, blog, and the scanner waitlist. Admin
authorization is enforced once here (``require_admin``) for the whole
subtree; individual handlers re-declare it only when they need the acting
